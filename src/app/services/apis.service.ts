...
export class ApisService {
  ...
  public register(email: string, password: string, fullname: string, phone: string): Promise<any> {
    return new Promise<any>((resolve, reject) => {
  ...
  /**
   * Gets the address for the user in the DB
  ...
  /**
   * Crea una orden nueva, y es añadida a la colección de ordenes de yochivoy
   * @param id Identificador de la orden en la coleccion "ORDERS"
   * @param param Datos de la orden
   */
