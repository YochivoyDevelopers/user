...
export class AddNewAddressPage implements OnInit {
  ...
  /**
   * Calcula un domicilio acorde a donde se arrastre el cursor de mapa
   * @param event Evento drag para calcular un domicilio en el mapa
   */
  getDragAddress(event) {
    // Configura GeoCoder de Google Maps
    const geocoder = new google.maps.Geocoder();
    // Configura punto en el mapa acorde a la info obtenida por el evento
  ...
  /**
   * Manejador de evento submit para el formulario de dirección
   */
  submit() {
    // Configura latitud y longitud  en localStorage
  ...
  /**
   * Añade dirección a Firestore en YoChiVoy-app
   */
  addAddress() {
