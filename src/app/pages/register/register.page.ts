...
export class RegisterPage implements OnInit {
  login: register = { email: '', password: '', full_name: '', confirmPassword: '', phone: '' };
  submitted = false;
  ...
  onLogin(form: NgForm) {
    ...
    if (form.valid) {
      ...
      console.log('login');
      this.isLogin = true;
      this.api.register(this.login.email, this.login.password, this.login.full_name,this.login.phone).then((userData) => {
